...
// if else yaptığımız uygulamanın aynısını
...
const age = 22;
    ...
    // if else yerine switch | switch yerine if else kullanılabilir hangisi daha clean code oluyorsa onu seçmemiz gerekir ama