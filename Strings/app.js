...
//val=val.indexOf("murat"); // bulduğu değerin index numarasını yazar. İIndex 0 dan başlar
...
//string search
val=val.replace("beyza","dev"); // beyza yerine dev yazar

//trim
val="          "+val.replace("beyza","dev")+"        ";
...
var url="http://www.google.com/ istanbul  javascript nutuk araştırma";
